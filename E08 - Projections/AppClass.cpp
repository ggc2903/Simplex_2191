...
void Application::InitVariables(void)
{
	...
	m_sProgrammer = "Grayson Crosby - ggc2903@rit.edu";
...
void Application::Display(void)
{
	...
	case 3:
		...
		m_pCamera->SetVerticalPlanes(vector2(-10.0f, 10.0f));
		break;
	case 4:
		m_pCamera->ResetCamera();
	...
	case 5:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(vector3(0.0f, 0.0f, -15.0f), vector3(0.0f, 0.0f, 0.0f), vector3(0.0f, 1.0f, 0.0f));
		m_pCamera->SetNearFar(vector2(5.0001f, 1000.0f));
		break;
	case 6:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(vector3(0.0f, 0.0f, -15.0f), vector3(0.0f, 0.0f, 0.0f), vector3(0.0f, 1.0f, 0.0f));
		m_pCamera->SetNearFar(vector2(0.0001f, 15.0f));
		break;
	case 7:
		m_pCamera->ResetCamera();
